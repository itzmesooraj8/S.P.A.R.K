      ...
      <div className="grid grid-cols-12 gap-3">
        ...
        <div className="col-span-3">
          ...
          <HudPanel title="Knowledge Graph" className="mt-3">
            ...
            <div className="mt-4 pt-3 border-t border-[#00f5ff20]">
              <div className="text-[9px] text-white/50 uppercase tracking-widest mb-2">Recent Recall</div>
              <div className="space-y-1.5 mb-3">
                <div className="text-[8px] text-white/70 truncate bg-white/5 p-1 rounded border border-white/5">Project_Solo: Discussed on Tuesday</div>
                <div className="text-[8px] text-white/70 truncate bg-white/5 p-1 rounded border border-white/5">Asset_CUPID: Bought 50 shares at 120</div>
                <div className="text-[8px] text-white/70 truncate bg-white/5 p-1 rounded border border-white/5">Concept_OODA: Core operating model</div>
              </div>
              <button 
                onClick={() => navigate('/memory')}
                className="w-full py-1.5 rounded border border-[#00f5ff40] text-[9px] text-[#00f5ff80] uppercase tracking-widest hover:bg-[#00f5ff10] hover:text-[#00f5ff] transition-all"
              >
                VIEW FULL GRAPH
              </button>
            </div>
