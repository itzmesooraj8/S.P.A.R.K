...
TOOLS = [
    ...
    },
    {
        "type": "function",
        "function": {
            "name": "run_swarm_router",
            "description": "Decompose and execute sequential structural compliance, slicing, and kinematics tasks using autonomous swarm routines.",
            "parameters": {
                "type": "object",
                "properties": {
                    "query": {
                        "type": "string",
                        "description": "Detailed engineering query or prompt to decompose and execute."
                    }
                },
                "required": ["query"]
            }
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "role": {
                        "type": "string",
                        "description": "The message author's role (user, assistant, system)."
                    },
                    "content": {
                        "type": "string",
                        "description": "The textual content of the message turn."
                    },
                    "state_metadata": {
                        "type": "object",
                        "description": "Optional agent/system state metadata to log.",
    ...
    },
    {
        "type": "function",
        "function": {
            "name": "verify_sandbox_metrics",
            "description": "Read and validate sandbox status/metrics JSON files generated by background workers, preventing path traversal and injection patterns.",
            "parameters": {
                "type": "object",
                "properties": {
                    "filename": {
                        "type": "string",
                        "description": "Target filename strictly within the authorized sandbox/ folder."
                    }
                },
                "required": ["filename"]
            }
...
async def _call_tool(tool_name: str, tool_args: dict[str, Any]) -> Any:
    ...
    if tool_name == "archive_session_state":
        ...
        await archivist.save_turn(
            ...
            state_metadata=tool_args.get("state_metadata")
        )
        return {"status": "success", "message": "Turn archived."}
    if tool_name == "verify_sandbox_metrics":
        from security.sandbox_memory_bridge import SandboxMemoryBridge
        bridge = SandboxMemoryBridge()
        data = bridge.read_worker_state(tool_args["filename"])
